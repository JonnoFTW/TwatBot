...
h3. Place the file
* Add a 'keys' file in the same directory as twatbot.py and fill it with your Twitter
  oAuth key.
...
h3. Commands
* Use '^^' to post the preceding line to Twitter, a command such as '^^ 6' which would 
  allow you to post the 6th line preceeding to Twitter is in the pipeline.
